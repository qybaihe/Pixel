...
像素圆桌是一款面向抖音精选视频的像素风 AI 观点辩论 iOS App。用户导入一条抖音精选视频后，App 会自动提炼视频背后的辩题、争议点和核心论据，并召集多位“专家角色”从不同立场展开圆桌讨论。

短视频很擅长输出鲜明观点，但单条视频往往只呈现一个角度。像素圆桌想做的是把这条视频变成一场可观看、可参与、可继续追问的多专家论坛：有人支持，有人反驳，有人补充事实，有人拆解逻辑，帮助用户从更立体的角度理解一个观点，而不是只被单一叙事带着走。

圆桌讨论之后，用户还可以选择一位专家进入 Battle，通过语音或文字继续说服对方。App 内置角色素材、像素动画、登场配音、BGM、论坛回看视频、长图分享等完整移动端体验。

## 核心流程

1. 导入抖音精选视频链接
2. AI 提炼视频议题、争议点和关键论据
3. 多位专家角色进入圆桌，从不同立场讨论和反驳
4. 用户选择一位专家进入语音 Battle，继续追问或说服
5. 生成论坛回看和观点长图，方便复盘与分享

## 功能亮点

- **抖音精选视频导入**：粘贴抖音精选视频链接后，线上服务会提炼辩题、争议点、核心论据和建议专家阵容。
- **多专家圆桌讨论**：多位专家按 Round 组织观点、反驳和收束，不只是轮流发言，而是会互相回应、质疑和博弈。
- **观点去单一化**：针对短视频观点容易片面、情绪化或信息密度不足的问题，用多个角色的知识背景和立场差异补齐讨论。
